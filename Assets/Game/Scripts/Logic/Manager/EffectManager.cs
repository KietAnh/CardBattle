...
public class EffectManager : SingletonTemplate<EffectManager>
{
    ...
    private Dictionary<string, Stack<GameObject>> _effectsPool = new Dictionary<string, Stack<GameObject>>();   // object pool
    ...
    private GameObject _PlayEffect(string name, EffectType type, Action callback = null, bool isCache = true)
    {
        ...
        CoroutineManager.Singleton.delayedCall(effect.duration + 0.1f, () =>
        {
            StopEffect(id);
        });
